...
%*************************EXCLUDING FRAMES ***********************************
\includeonlyframes{abstract_setup,shannon_pipeline_source_channel, references}
...
In any abstract setup there always is symetrical 
...
\end{tikzpicture}
 ...
 \begin{textblock*}{2cm}(0.95\textwidth,0.93\textheight) \scriptsize DDDDD \end{textblock*}
