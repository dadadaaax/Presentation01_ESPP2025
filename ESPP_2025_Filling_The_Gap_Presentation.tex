...
\includeonlyframes{fly_frog_pipeline, references}
...
\begin{frame}[label=gap] {(Some)kinds of information in the scientific literature}
...
\begin{frame}[label=fly_frog_pipeline]{ Cognitive casusal processing pipeline of the agent in the environment}
    ...
    \begin{center}
    Each part in the agent is performing some task function in the teleological sense. The inner part of pipeline  a dual characteristic "pushme-pullyou" of mental representation (\cite{millikan_pushme-pullyou_2017}).
    (characteristics)
    \end{center}
